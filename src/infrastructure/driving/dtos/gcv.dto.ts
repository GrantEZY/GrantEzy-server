...
export class AddProgramManagerDTO {
    @ApiProperty({
        description: "UUID of the program need to added with manager",
    })
    @IsUUID()
    id: string;
...
export class UpdateProgramManagerDTO {
    @ApiProperty({
        description: "UUID of the program need to updated with manager",
    })
    @IsUUID()
    id: string;
